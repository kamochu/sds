 ...
 */
public class SubscriptionsProducer implements Runnable {

    private final static Logger log = Logger.getLogger(SubscriptionsProducer.class.getName());
    ...
    public SubscriptionsProducer(LinkedList<SubscriptionMessage> sharedQueue) {
