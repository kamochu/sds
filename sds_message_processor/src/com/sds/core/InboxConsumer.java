...
public class InboxConsumer implements Runnable {
    ...
    private final static Logger log = Logger.getLogger(InboxConsumer.class.getName());
    ...
    public InboxConsumer(LinkedList<InboxMessage> sharedQueue) {
    ...
    private InboxMessage consume() throws InterruptedException {
