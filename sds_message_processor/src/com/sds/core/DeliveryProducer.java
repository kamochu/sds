 ...
 */
public class DeliveryProducer implements Runnable {

    private final static Logger log = Logger.getLogger(DeliveryProducer.class.getName());
    ...
    public DeliveryProducer(LinkedList<DeliveryMessage> sharedQueue) {
